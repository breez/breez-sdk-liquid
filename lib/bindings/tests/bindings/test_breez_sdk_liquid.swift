...
var config = try breez_sdk_liquid.defaultConfig(network: .regtest, breezApiKey: nil)
...
print(nodeInfo)
assert(
    nodeInfo.walletInfo.pubkey
        == "03d902f35f560e0470c63313c7369168d9d7df2d49bf295fd9fb7cb109ccee0494", "nodeInfo.pubkey")
