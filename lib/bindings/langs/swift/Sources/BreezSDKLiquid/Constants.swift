...
struct Constants {
    ...
    static let NWC_EVENT_NOTIFICATION_TITLE = "nwc_event_notification_title"
    static let NWC_EVENT_NOTIFICATION_FAILURE_TITLE = "nwc_event_notification_failure_title"
    static let NWC_EVENT_NOTIFICATION_TEXT = "nwc_event_notification_text"
    static let NWC_EVENT_NOTIFICATION_FAILURE_TEXT = "nwc_event_notification_failure_text"
    ...
    static let DEFAULT_NWC_EVENT_NOTIFICATION_TITLE = "NWC Event Received"
    static let DEFAULT_NWC_EVENT_NOTIFICATION_FAILURE_TITLE = "NWC Event Failed"
    static let DEFAULT_NWC_EVENT_NOTIFICATION_TEXT = "NWC Event has been processed successfully"
    static let DEFAULT_NWC_EVENT_NOTIFICATION_FAILURE_TEXT = "NWC Event processing failed"
