...
import breez_sdk_liquid_notification.Constants.DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_DESCRIPTION
import breez_sdk_liquid_notification.Constants.DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_NAME
import breez_sdk_liquid_notification.Constants.DEFAULT_DISMISSABLE_WORKGROUP_DESCRIPTION
import breez_sdk_liquid_notification.Constants.DEFAULT_DISMISSABLE_WORKGROUP_NAME
...
import breez_sdk_liquid_notification.Constants.DISMISSABLE_NOTIFICATION_CHANNEL_DESCRIPTION
import breez_sdk_liquid_notification.Constants.DISMISSABLE_NOTIFICATION_CHANNEL_NAME
import breez_sdk_liquid_notification.Constants.DISMISSABLE_WORKGROUP_DESCRIPTION
import breez_sdk_liquid_notification.Constants.DISMISSABLE_WORKGROUP_ID
import breez_sdk_liquid_notification.Constants.DISMISSABLE_WORKGROUP_NAME
...
import breez_sdk_liquid_notification.Constants.NOTIFICATION_CHANNEL_DISMISSABLE
...
class NotificationHelper {
    companion object {
        ...
        private fun createNotificationChannels(
            ...
            val replaceableNotificationChannel =
                NotificationChannel(
                    ...
                    getString(
                        context,
                        DISMISSABLE_NOTIFICATION_CHANNEL_NAME,
                        DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_NAME,
                    ),
                    ...
                    description =
                        getString(
                            context,
                            DISMISSABLE_NOTIFICATION_CHANNEL_DESCRIPTION,
                            DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_DESCRIPTION,
                        )
                    group = REPLACEABLE_WORKGROUP_ID
                }
            val dismissableNotificationChannel =
                NotificationChannel(
                    "$applicationId.${NOTIFICATION_CHANNEL_DISMISSABLE}",
                    getString(
                        context,
                        DISMISSABLE_NOTIFICATION_CHANNEL_NAME,
                        DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_NAME,
        ...
        private fun createNotificationChannelGroups(
            ...
            val dismissableNotificationChannelGroup =
                NotificationChannelGroup(
                    DISMISSABLE_WORKGROUP_ID,
                    getString(
                        context,
                        DISMISSABLE_WORKGROUP_NAME,
                        DEFAULT_DISMISSABLE_WORKGROUP_NAME,
                    ),
                )
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ...
                dismissableNotificationChannelGroup.description =
                    getString(
                        context,
                        DISMISSABLE_WORKGROUP_DESCRIPTION,
                        DEFAULT_DISMISSABLE_WORKGROUP_DESCRIPTION,
                    )
            }
            ...
            notificationManager.createNotificationChannelGroups(
                listOf(
                    ...
                    dismissableNotificationChannelGroup,
                ),
            )
        }
        ...
        fun notifyChannel(
            ...
            val notificationID: Int =
                if (channelId ==
                    NOTIFICATION_CHANNEL_DISMISSABLE
                ) {
