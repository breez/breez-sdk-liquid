...
object Constants {
    ...
    const val NOTIFICATION_CHANNEL_DISMISSABLE = "DISMISSABLE"
    ...
    const val DISMISSABLE_NOTIFICATION_CHANNEL_DESCRIPTION =
        "DISMISSABLE_NOTIFICATION_CHANNEL_description"
    const val DISMISSABLE_NOTIFICATION_CHANNEL_NAME =
        "DISMISSABLE_NOTIFICATION_CHANNEL_name"
    const val DISMISSABLE_WORKGROUP_ID = "dismissable"
    const val DISMISSABLE_WORKGROUP_DESCRIPTION =
        "dismissable_work_group_description"
    const val DISMISSABLE_WORKGROUP_NAME = "dismissable_work_group_name"
    ...
    const val DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_DESCRIPTION =
        "Channel for dismissable notifications when the application is in the background"
    const val DEFAULT_DISMISSABLE_NOTIFICATION_CHANNEL_NAME = "Dismissable Notifications"
    const val DEFAULT_DISMISSABLE_WORKGROUP_DESCRIPTION =
        "Required to handle dismissable notifications when the application is in the background"
    const val DEFAULT_DISMISSABLE_WORKGROUP_NAME = "Dismissable Notifications"
