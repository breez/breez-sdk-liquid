...
pub(crate) mod onchain {
    ...
    impl LiquidSdk {
        ...
        pub(crate) async fn get_onchain_data(
            ...
            let mut send_swaps_script_to_history_map: HashMap<Script, Vec<History>> =
                HashMap::new();
            let mut receive_swaps_script_to_history_map: HashMap<Script, Vec<History>> =
                HashMap::new();
