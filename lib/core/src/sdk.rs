...
impl LiquidSdk {
    ...
    pub async fn prepare_send_payment(
                            ...
                            true => {
                                ...
                                ensure_sdk!(
                                    ...
                                    PaymentError::InsufficientFunds {
                                        missing_sats: (swap.payer_amount_sat + swap.fees_sat)
                                            - get_info_res.wallet_info.balance_sat,
                                    }
                                );
        ...
        Ok(PrepareSendResponse {
            ...
            payment_timeout_sec: Some(timeout_sec),
        })
    }
    ...
    pub async fn send_payment(
        ...
        let timeout_sec = payment_timeout_sec.unwrap_or(self.config.payment_timeout_sec);
    ...
    async fn pay_sideswap(
        ...
        ensure_sdk!(
            ...
            PaymentError::InsufficientFunds {
                missing_sats: swap.payer_amount_sat - balance_sat
            }
        );
