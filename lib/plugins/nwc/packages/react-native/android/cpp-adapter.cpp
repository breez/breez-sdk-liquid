...
// Automated testing checks Java_com_breezsdkliquidnwc_BreezSdkLiquidNwcModule and breezsdkliquidnwc
// by comparing the whole line here.
/*
Java_com_breezsdkliquidnwc_BreezSdkLiquidNwcModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return breezsdkliquidnwc::multiply(a, b);
}
*/

// Installer coming from BreezSdkLiquidNwcModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_breezsdkliquidnwc_BreezSdkLiquidNwcModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return breezsdkliquidnwc::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_breezsdkliquidnwc_BreezSdkLiquidNwcModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return breezsdkliquidnwc::cleanupRustCrate(*runtime);
}