...
final String? redirectUrl;
                ...
                const BuyBitcoinRequest({required this.prepareRes ,this.redirectUrl ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is BuyBitcoinRequest &&
                runtimeType == other.runtimeType
                && prepareRes == other.prepareRes&& redirectUrl == other.redirectUrl;
...
final BigInt? zeroConfMaxAmountSat;
                ...
                const Config({required this.liquidElectrumUrl ,required this.bitcoinElectrumUrl ,required this.mempoolspaceUrl ,required this.workingDir ,required this.network ,required this.paymentTimeoutSec ,required this.zeroConfMinFeeRateMsat ,this.zeroConfMaxAmountSat ,});
        ...
        @override
        int get hashCode => liquidElectrumUrl.hashCode^bitcoinElectrumUrl.hashCode^mempoolspaceUrl.hashCode^workingDir.hashCode^network.hashCode^paymentTimeoutSec.hashCode^zeroConfMinFeeRateMsat.hashCode^zeroConfMaxAmountSat.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is Config &&
                runtimeType == other.runtimeType
                && liquidElectrumUrl == other.liquidElectrumUrl&& bitcoinElectrumUrl == other.bitcoinElectrumUrl&& mempoolspaceUrl == other.mempoolspaceUrl&& workingDir == other.workingDir&& network == other.network&& paymentTimeoutSec == other.paymentTimeoutSec&& zeroConfMinFeeRateMsat == other.zeroConfMinFeeRateMsat&& zeroConfMaxAmountSat == other.zeroConfMaxAmountSat;
...
final Config config;
                ...
                const ConnectRequest({required this.mnemonic ,required this.config ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ConnectRequest &&
                runtimeType == other.runtimeType
                && mnemonic == other.mnemonic&& config == other.config;
...
final String pubkey;
                ...
                const GetInfoResponse({required this.balanceSat ,required this.pendingSendSat ,required this.pendingReceiveSat ,required this.pubkey ,});
        ...
        @override
        int get hashCode => balanceSat.hashCode^pendingSendSat.hashCode^pendingReceiveSat.hashCode^pubkey.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is GetInfoResponse &&
                runtimeType == other.runtimeType
                && balanceSat == other.balanceSat&& pendingSendSat == other.pendingSendSat&& pendingReceiveSat == other.pendingReceiveSat&& pubkey == other.pubkey;
...
final Limits receive;
        ...
        bool operator ==(Object other) =>
            ...
            other is LightningPaymentLimitsResponse &&
                runtimeType == other.runtimeType
                && send == other.send&& receive == other.receive;
...
final BigInt maxZeroConfSat;
        ...
        bool operator ==(Object other) =>
            ...
            other is Limits &&
                runtimeType == other.runtimeType
                && minSat == other.minSat&& maxSat == other.maxSat&& maxZeroConfSat == other.maxZeroConfSat;
...
final int? limit;
                ...
                const ListPaymentsRequest({this.filters ,this.fromTimestamp ,this.toTimestamp ,this.offset ,this.limit ,});
        ...
        @override
        int get hashCode => filters.hashCode^fromTimestamp.hashCode^toTimestamp.hashCode^offset.hashCode^limit.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ListPaymentsRequest &&
                runtimeType == other.runtimeType
                && filters == other.filters&& fromTimestamp == other.fromTimestamp&& toTimestamp == other.toTimestamp&& offset == other.offset&& limit == other.limit;
...
@freezed
                sealed class LnUrlPayResult with _$LnUrlPayResult  {
                    const LnUrlPayResult._();
                     ...
                     const factory LnUrlPayResult.endpointSuccess({   required LnUrlPaySuccessData data , }) = LnUrlPayResult_EndpointSuccess;
...
final SuccessActionProcessed? successAction;
        ...
        bool operator ==(Object other) =>
            ...
            other is LnUrlPaySuccessData &&
                runtimeType == other.runtimeType
                && payment == other.payment&& successAction == other.successAction;
...
final PreparePayOnchainResponse prepareRes;
                ...
                const PayOnchainRequest({required this.address ,required this.prepareRes ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PayOnchainRequest &&
                runtimeType == other.runtimeType
                && address == other.address&& prepareRes == other.prepareRes;
...
final PaymentState status;
                ...
                const Payment({this.txId ,this.swapId ,required this.timestamp ,required this.amountSat ,required this.feesSat ,this.preimage ,this.bolt11 ,required this.description ,this.refundTxId ,this.refundTxAmountSat ,required this.paymentType ,required this.status ,});
        ...
        @override
        int get hashCode => txId.hashCode^swapId.hashCode^timestamp.hashCode^amountSat.hashCode^feesSat.hashCode^preimage.hashCode^bolt11.hashCode^description.hashCode^refundTxId.hashCode^refundTxAmountSat.hashCode^paymentType.hashCode^status.hashCode;
...
final BigInt amountSat;
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareBuyBitcoinRequest &&
                runtimeType == other.runtimeType
                && provider == other.provider&& amountSat == other.amountSat;
...
final BigInt feesSat;
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareBuyBitcoinResponse &&
                runtimeType == other.runtimeType
                && provider == other.provider&& amountSat == other.amountSat&& feesSat == other.feesSat;
...
final int? satPerVbyte;
                ...
                const PreparePayOnchainRequest({required this.receiverAmountSat ,this.satPerVbyte ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PreparePayOnchainRequest &&
                runtimeType == other.runtimeType
                && receiverAmountSat == other.receiverAmountSat&& satPerVbyte == other.satPerVbyte;
...
final BigInt totalFeesSat;
                ...
                const PreparePayOnchainResponse({required this.receiverAmountSat ,required this.claimFeesSat ,required this.totalFeesSat ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PreparePayOnchainResponse &&
                runtimeType == other.runtimeType
                && receiverAmountSat == other.receiverAmountSat&& claimFeesSat == other.claimFeesSat&& totalFeesSat == other.totalFeesSat;
...
class PrepareReceiveOnchainRequest  {
                ...
                const PrepareReceiveOnchainRequest({required this.payerAmountSat ,});
...
final BigInt feesSat;
                ...
                const PrepareReceiveOnchainResponse({required this.payerAmountSat ,required this.feesSat ,});
...
final bool useLightning;
                ...
                const PrepareReceivePaymentRequest({this.payerAmountSat ,required this.useLightning ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareReceivePaymentRequest &&
                runtimeType == other.runtimeType
                && payerAmountSat == other.payerAmountSat&& useLightning == other.useLightning;
...
final bool useLightning;
                ...
                const PrepareReceivePaymentResponse({this.payerAmountSat ,required this.feesSat ,required this.useLightning ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareReceivePaymentResponse &&
                runtimeType == other.runtimeType
                && payerAmountSat == other.payerAmountSat&& feesSat == other.feesSat&& useLightning == other.useLightning;
...
final int satPerVbyte;
                ...
                const PrepareRefundRequest({required this.swapAddress ,required this.refundAddress ,required this.satPerVbyte ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareRefundRequest &&
                runtimeType == other.runtimeType
                && swapAddress == other.swapAddress&& refundAddress == other.refundAddress&& satPerVbyte == other.satPerVbyte;
...
final String? refundTxId;
                ...
                const PrepareRefundResponse({required this.txVsize ,required this.txFeeSat ,this.refundTxId ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareRefundResponse &&
                runtimeType == other.runtimeType
                && txVsize == other.txVsize&& txFeeSat == other.txFeeSat&& refundTxId == other.refundTxId;
...
final BigInt? amountSat;
                ...
                const PrepareSendRequest({required this.paymentDestination ,this.amountSat ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is PrepareSendRequest &&
                runtimeType == other.runtimeType
                && paymentDestination == other.paymentDestination&& amountSat == other.amountSat;
...
@freezed
                sealed class ReceiveDestination with _$ReceiveDestination  {
                    const ReceiveDestination._();
                     ...
                     const factory ReceiveDestination.bip21({   required String uri , }) = ReceiveDestination_BIP21;
 const factory ReceiveDestination.liquid({   required String address , }) = ReceiveDestination_Liquid;
 const factory ReceiveDestination.bolt11({   required String id ,  required String invoice , }) = ReceiveDestination_Bolt11;
...
final String bip21;
                ...
                const ReceiveOnchainResponse({required this.address ,required this.bip21 ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ReceiveOnchainResponse &&
                runtimeType == other.runtimeType
                && address == other.address&& bip21 == other.bip21;
...
final PrepareReceivePaymentResponse prepareResponse;
                ...
                const ReceivePaymentRequest({this.description ,required this.prepareResponse ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ReceivePaymentRequest &&
                runtimeType == other.runtimeType
                && description == other.description&& prepareResponse == other.prepareResponse;
...
class ReceivePaymentResponse  {
                ...
                const ReceivePaymentResponse({required this.receiveDestination ,});
...
final int satPerVbyte;
                ...
                const RefundRequest({required this.swapAddress ,required this.refundAddress ,required this.satPerVbyte ,});
...
final BigInt amountSat;
                ...
                const RefundableSwap({required this.swapAddress ,required this.timestamp ,required this.amountSat ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is RefundableSwap &&
                runtimeType == other.runtimeType
                && swapAddress == other.swapAddress&& timestamp == other.timestamp&& amountSat == other.amountSat;
...
@freezed
 ...
 const factory SdkEvent.paymentWaitingConfirmation({   required Payment details , }) = SdkEvent_PaymentWaitingConfirmation;
