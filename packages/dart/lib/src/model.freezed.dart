...
/// @nodoc
abstract class _$$BlockchainExplorer_MempoolSpaceImplCopyWith<$Res>
    implements $BlockchainExplorerCopyWith<$Res> {
  factory _$$BlockchainExplorer_MempoolSpaceImplCopyWith(
    _$BlockchainExplorer_MempoolSpaceImpl value,
    $Res Function(_$BlockchainExplorer_MempoolSpaceImpl) then,
  ) = __$$BlockchainExplorer_MempoolSpaceImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String url});
}
...
/// @nodoc
class __$$BlockchainExplorer_MempoolSpaceImplCopyWithImpl<$Res>
    extends _$BlockchainExplorerCopyWithImpl<$Res, _$BlockchainExplorer_MempoolSpaceImpl>
    implements _$$BlockchainExplorer_MempoolSpaceImplCopyWith<$Res> {
  __$$BlockchainExplorer_MempoolSpaceImplCopyWithImpl(
    _$BlockchainExplorer_MempoolSpaceImpl _value,
    $Res Function(_$BlockchainExplorer_MempoolSpaceImpl) _then,
  ) : super(_value, _then);
  ...
  $Res call({Object? url = null}) {
    return _then(
      _$BlockchainExplorer_MempoolSpaceImpl(
        url:
            null == url
                ? _value.url
                : url // ignore: cast_nullable_to_non_nullable
...
class _$BlockchainExplorer_MempoolSpaceImpl extends BlockchainExplorer_MempoolSpace {
  const _$BlockchainExplorer_MempoolSpaceImpl({required this.url}) : super._();
  ...
  @override
  String toString() {
    return 'BlockchainExplorer.mempoolSpace(url: $url)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BlockchainExplorer_MempoolSpaceImpl &&
            (identical(other.url, url) || other.url == url));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BlockchainExplorer_MempoolSpaceImplCopyWith<_$BlockchainExplorer_MempoolSpaceImpl> get copyWith =>
      __$$BlockchainExplorer_MempoolSpaceImplCopyWithImpl<_$BlockchainExplorer_MempoolSpaceImpl>(
        this,
        _$identity,
      );
}

abstract class BlockchainExplorer_MempoolSpace extends BlockchainExplorer {
  const factory BlockchainExplorer_MempoolSpace({required final String url}) =
      _$BlockchainExplorer_MempoolSpaceImpl;
  const BlockchainExplorer_MempoolSpace._() : super._();
