...
const factory LnUrlAuthError.serviceConnectivity({   required String err , }) = LnUrlAuthError_ServiceConnectivity;
...
const factory LnUrlCallbackStatus.errorStatus({   required LnUrlErrorData data , }) = LnUrlCallbackStatus_ErrorStatus;
...
const factory LnUrlWithdrawError.invoiceNoRoutingHints({   required String err , }) = LnUrlWithdrawError_InvoiceNoRoutingHints;
 /// This error is raised when a connection to an external service fails.
const factory LnUrlWithdrawError.serviceConnectivity({   required String err , }) = LnUrlWithdrawError_ServiceConnectivity;
...
@freezed
 ...
 const factory LnUrlWithdrawResult.timeout({   required LnUrlWithdrawSuccessData data , }) = LnUrlWithdrawResult_Timeout;
 const factory LnUrlWithdrawResult.errorStatus({   required LnUrlErrorData data , }) = LnUrlWithdrawResult_ErrorStatus;
