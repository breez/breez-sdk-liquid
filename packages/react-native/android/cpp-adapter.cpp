...
// Automated testing checks Java_com_breeztech_breezsdkliquid_ReactNativeBreezSdkLiquidModule and breeztech_reactnativebreezsdkliquid
// by comparing the whole line here.
/*
Java_com_breeztech_breezsdkliquid_ReactNativeBreezSdkLiquidModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return breeztech_reactnativebreezsdkliquid::multiply(a, b);
}
*/

// Installer coming from ReactNativeBreezSdkLiquidModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_breeztech_breezsdkliquid_ReactNativeBreezSdkLiquidModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return breeztech_reactnativebreezsdkliquid::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_breeztech_breezsdkliquid_ReactNativeBreezSdkLiquidModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return breeztech_reactnativebreezsdkliquid::cleanupRustCrate(*runtime);
}